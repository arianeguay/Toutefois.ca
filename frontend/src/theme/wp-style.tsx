...
import { mobileTheme, theme } from './index';
...
export const WordpressStyling = css`
   ...
   * ---------------------------------------------- */
    ...
    p {
      ...
      &:not(:first-child) {
        margin-block-start: ${({ theme }) =>
          fluidSpace(mobileTheme.spacing.xs, theme.spacing.sm)};
      }
      &:not(:last-child) {
        margin-block-end: ${({ theme }) =>
          fluidSpace(mobileTheme.spacing.xs, theme.spacing.sm)};
      }
    ...
    h2 {
      margin-block-start: ${({ theme }) =>
        fluidSpace(mobileTheme.spacing.sm, theme.spacing.md)};
      &:not(:last-child) {
        margin-block-end: ${({ theme }) =>
          fluidSpace(mobileTheme.spacing.xs, theme.spacing.sm)};
      }
   ...
   * ---------------------------------------------- */
    ...
    ol ul {
      margin: 3px 0 3px
        ${({ theme }) => fluidSpace(mobileTheme.spacing.xs, 8)}px;
    }
   ...
   * ---------------------------------------------- */
    ...
    .wp-caption-text {
      /* Fluid type */
      font-size: ${({ theme }) =>
        clampPx(mobileTheme.fontSizes.small, theme.fontSizes.small)};
      line-height: 1.4;
      color: ${({ theme }) => theme.colors.secondaryText};
      text-align: center;
   ...
   * ---------------------------------------------- */
    ...
    input[type='button'] {
      ...
      padding: ${({ theme }) =>
          fluidSpace(mobileTheme.spacing.sm, theme.spacing.sm)}px
   ...
   * ---------------------------------------------- */
    ...
    .wp-block-column.has-background {
      padding: ${({ theme }) =>
        fluidSpace(mobileTheme.spacing.xs / 2, theme.spacing.xs)};
      border-radius: ${({ theme }) => theme.borderRadius.xs}px;
    }
   ...
   * ---------------------------------------------- */
    ...
    .wp-block-toutefois-projects-list {
      ...
      .projects-grid {
        ...
        gap: ${({ theme }) =>
          fluidSpace(mobileTheme.spacing.xs / 2, theme.spacing.xs / 2)};
      }
      .project-item {
    ...
    .content-carousel-block {
      ...
      padding-inline: ${({ theme }) =>
        fluidSpace(mobileTheme.spacing.lg, theme.spacing.xl)};
      padding-block-end: ${({ theme }) =>
        fluidSpace(mobileTheme.spacing.xs, theme.spacing.xs)};
    }
    ...
    .content-carousel-block > ul {
      ...
      display: grid;
      gap: ${({ theme }) =>
        fluidSpace(mobileTheme.spacing.xs, theme.spacing.md)};
      width: 100%;
    }
  ...
  .wp-block-toutefois-featured-carousel {
    ...
    .toutefois-featured-carousel__list {
      ...
      grid-template-columns: 1fr;
      gap: ${({ theme }) =>
        fluidSpace(mobileTheme.spacing.md, theme.spacing.lg)};
    }
    @media (min-width: ${({ theme }) => theme.breakpoints.md}) {
      .toutefois-featured-carousel__list {
        grid-template-columns: repeat(2, 1fr);
